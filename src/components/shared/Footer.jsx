        ...
        <div className="row gy-4">
            ...
            <ul className="list-unstyled d-grid gap-2">
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="d-inline-flex align-items-center gap-2 text-light"
                >
          ...
          <div className="col-12 col-md-3">
            ...
            <ul className="list-unstyled d-grid gap-2">
              ...
              <li>
                <a
                  href="http://google.com/maps?q=Gral.+Jos%C3%A9+Mar%C3%ADa+Paz+576,+San+Miguel+de+Tucum%C3%A1n,+Tucum%C3%A1n"
                  className="d-inline-flex align-items-center gap-2 text-light"
                >
