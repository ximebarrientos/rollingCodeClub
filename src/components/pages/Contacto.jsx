...
const Contacto = () => {
  return (
    <Container className="my-5">
            <h2 className="mb-4 text-center text-success display-6">Información de Contacto</h2>
                ...
                <Col xs={12} md={6} lg={4}>
                    <Card className="h-100 text-center shadow-sm">
                        <Card.Body>
                            ...
                            <Card.Text>
                                <a href="https://facebook.com" target="_blank" className="me-3 text-info"><i className="bi bi-facebook display-6"></i></a>
                                <a href="https://instagram.com" target="_blank" className="me-3 text-danger"><i className="bi bi-instagram display-6"></i></a>
                                <a href="https://twitter.com" target="_blank" className="text-dark"><i className="bi bi-twitter-x display-6"></i></a>
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </Col>
